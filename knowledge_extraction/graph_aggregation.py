...
if __name__ == '__main__':
    ...
    parser = argparse.ArgumentParser(
        description="run graph aggregation"
    )
    parser.add_argument(
        '-dp',
    ...
    parser.add_argument(
        ...
        metavar='--sdg-config',
        type=str,
        help="path to the synthetic datagenerator config.",
        default=None,
        required=False
    )
    ...
    dp = data_provider_singleton.get_data_provider(dp_kind, config=sdg_config)
