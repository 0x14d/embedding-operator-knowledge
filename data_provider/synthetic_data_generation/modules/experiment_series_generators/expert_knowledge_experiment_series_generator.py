    ...
    def _generate_single_experiment_series(self, qualities: List[str]) -> GeneratedExperimentSeries:
        ...
        while True:
            ...
            for parameter in adjusted_parameters:
                ...
                affected_qualities = set(affected_qualities) & set(qualities)
                # And add
                # affected_qualities = set(self._pq_tuples.get_expert_knowledge_for_parameter(parameter)) & set(qualities)
