...
from data_provider.synthetic_data_generation.config.modules.knowledge_graph_generator_config \
    import QuantifiedParametersWithShortcutKnowledgeGraphGeneratorConfig, EdgeWeightCalculationMethod
...
class QuantifiedParametersWithShortcut(KnowledgeGraphGenerator):
    """
    ...
    _config: QuantifiedParametersWithShortcutKnowledgeGraphGeneratorConfig
