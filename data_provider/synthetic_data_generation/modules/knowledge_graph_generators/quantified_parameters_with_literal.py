...
from data_provider.synthetic_data_generation.config.modules.knowledge_graph_generator_config \
    import QuantifiedParametersWithLiteralKnowledgeGraphGeneratorConfig, EdgeWeightCalculationMethod
...
class QuantifiedParametersWithLiteral(KnowledgeGraphGenerator):
    """
    ...
    _config: QuantifiedParametersWithLiteralKnowledgeGraphGeneratorConfig
    ...
    def generate_knowledge_graph(self) -> Graph:
        ...
        for pair in pq_tuples_included:
            ...
            added['weight'] = "implies" # TODO change weight to name
