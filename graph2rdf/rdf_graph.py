...
class PPKG_LITERALS(DefinedNamespace):
    ...
    _NS = Namespace("http://ppkg.org/ppkg/literals#")
...
class RDFGraph:
    ...
    _data_uri: str = 'http://ppkg.org/ppkg/resource/'
    ...
    def _rdf_setup(self):
        ...
        vocab_namespace = Namespace('http://ppkg.org/ppkg/vocab/')

        # The URI for our graph
        graph_uri = URIRef('http://ppkg.org/ppkg/resource/graph')
