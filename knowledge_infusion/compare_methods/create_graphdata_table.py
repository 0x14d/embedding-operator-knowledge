"""If compare methods was configured to create graph information (e.g closeness centrality, ...) this module scans for 
the files puts the graph informations into Excel and Latex tables
"""
...
def create_graph_data_tables():
    ...
    for exp_path in exps:
        ...
        for file in train_files:
            for val in vals:
                kg_label = KnowledgeGraphGeneratorType(file['representation']).latex_label
